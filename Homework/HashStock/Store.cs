...
namespace HashStock
{
    public class Store
    {
        ...
        private void LoadProducts()
        {
            ...
            // A6
            AddProduct(new Product(){
                Name = "Dish soap", // Sabao para louca
                Location = "A6"
            });
            AddProduct(new Product(){
            ...
            // B3
            AddProduct(new Product(){
                Name = "Whole grains", // Graos Integrais
                Location = "B3"
            });
            AddProduct(new Product(){
                Name = "Dried fruits",
            ...
            AddProduct(new Product(){
                Name = "Clearance items", // Itens de liquidacao
                Location = "B9"
            });
            ...
            // C2
            AddProduct(new Product(){
                Name = "Pain relievers", // Analgesico
                Location = "C2"
            });
            AddProduct(new Product(){
                Name = "Cold medicine",
            ...
            AddProduct(new Product(){
                Name = "Highlighters", // Especie de marcadores
                Location = "C6"
            });
